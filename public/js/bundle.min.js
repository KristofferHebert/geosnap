...
/***/ function(module, exports, __webpack_require__) {
	...
	var _snap = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Wrapper = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    if (this.isMounted()) {
	      this.setState({ isLoggedIn: (0, _isloggedin2.default)() });
	    }
	  },
	  renderSignUp: function renderSignUp(isLoggedIn) {
	    ...
	    var signOut = _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        _reactRouter.Link,
	        { activeClassName: 'active', to: '/user/signout' },
	        'Sign Out'
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	function isLoggedIn() {
	  return _auth2.default.isLoggedIn();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _userform = __webpack_require__(13);
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        _offline2.default,
	        null,
	        _react2.default.createElement(_userform2.default, { type: 'signup' })
	      )
	    );
	  }
	});
	...
	var UserForm = _react2.default.createClass({
	  ...
	  renderNameInput: function renderNameInput(type) {
	    var nameInput = _react2.default.createElement(
	      ...
	      _react2.default.createElement('input', { type: 'name', className: 'form-control', id: 'name', placeholder: 'Name', required: true })
	    );
	  ...
	  renderForm: function renderForm(type) {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'email', className: 'form-control', id: 'email', placeholder: 'Email', required: true })
	      ),
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'password', className: 'form-control', id: 'password', placeholder: 'Password', required: true })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'checkbox' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _webcamcanvas = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _handleChange = __webpack_require__(16);

	var _handleChange2 = _interopRequireDefault(_handleChange);

	var _getUserMedia = __webpack_require__(17);
	...
	var WebCamCanvas = _react2.default.createClass({
	  ...
	  updateWebCanvas: function updateWebCanvas() {
	    var canvas = this.refs.webcamcanvas;
	    var ctx = canvas.getContext('2d');
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('input', { type: 'text', name: 'geo', value: this.state.geo, className: 'form-control geo-locate', placeholder: 'geolocation' }),
	      ...
	      _react2.default.createElement('input', { type: 'submit', className: 'btn btn-primary btn-block', value: 'Submit' })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function handleChange(stateAttribute, objectPrefix, cbs) {
	  ...
	  return function (e) {
	    e.preventDefault();
	    var updatedState = objectPrefix ? _this.state[objectPrefix] : {};

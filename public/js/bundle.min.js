	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'email', className: 'form-control', id: 'email',
	          value: this.state.form.email, placeholder: 'Email', onChange: this.handleChange('email', 'form'), required: true, tabIndex: 30 })
	      ),
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'password', className: 'form-control', id: 'password',
	          value: this.state.form.password, placeholder: 'Password', onChange: this.handleChange('password', 'form'), required: true, tabIndex: 32 })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'checkbox' },

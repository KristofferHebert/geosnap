...
/***/ function(module, exports, __webpack_require__) {
	...
	var _snap = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _offlinesave = __webpack_require__(17);

	var _offlinesave2 = _interopRequireDefault(_offlinesave);
	...
	var Wrapper = _react2.default.createClass({
	  ...
	  pollOfflineData: function pollOfflineData() {
	    this.timer = setInterval(function () {
	      _offlinesave2.default.checkForOfflineData(_auth2.default.getCurrentUser(), '/snap/upload', navigator.onLine);
	    }, 5000);
	  },
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'a',
	                { href: '/', className: 'navbar-brand', tabIndex: 1 },
	                'GeoSnap'
	              )
	            ),
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  _reactRouter.Link,
	                  { activeClassName: 'active', to: '/', tabIndex: 2 },
	                  'Feed'
	                )
	              ),
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  _reactRouter.Link,
	                  { activeClassName: 'active', to: '/snap', tabIndex: 3 },
	                  'Snap'
	                )
	              ),
	  ...
	  renderNameInput: function renderNameInput(type) {
	    var nameInput = _react2.default.createElement(
	      ...
	      _react2.default.createElement('input', { type: 'name', className: 'form-control', id: 'name',
	        value: this.state.form.name, placeholder: 'Name', onChange: this.handleChange('name', 'form'), required: true, tabIndex: 31 })
	    );
	  ...
	  renderForm: function renderForm(type) {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'label',
	          { className: 'email', 'for': 'email' },
	          'Email address'
	        ),
	        _react2.default.createElement('input', { type: 'email', name: 'email', className: 'form-control', id: 'email',
	          value: this.state.form.email, placeholder: 'Email', onChange: this.handleChange('email', 'form'), required: true, tabIndex: 30, autocomplete: true })
	      ),
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'label',
	          { className: 'password', 'for': 'password' },
	          'Password'
	        ),
	        _react2.default.createElement('input', { type: 'password', name: 'password', className: 'form-control', id: 'password',
	          value: this.state.form.password, placeholder: 'Password', onChange: this.handleChange('password', 'form'), required: true, tabIndex: 32, autocomplete: true })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'checkbox' },
	        _react2.default.createElement(
	          'button',
	          { type: 'submit', className: 'btn btn-primary', tabIndex: 33 },
	          this.state.label
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	OfflineSave.save = function (data) {
	  var base = _auth2.default.getCurrentUser();
	  if (base.indexOf('geosnap_') === -1) {
	    base = 'geosnap_' + base;
	  }
	  var user = _auth2.default.getUser(base) || {};
	...
	OfflineSave.sync = function (userData, endpoint) {
	  ...
	  userData = userData.map(function (data, i) {
	    var request = {
	      headers: {
	        'Accept': 'application/json',
	        'Content-Type': 'application/json'
	    ...
	    return (0, _makerequest2.default)(endpoint, request);
	  });
	...
	OfflineSave.checkForOfflineData = function (userID, endpoint, isOnline) {
	  ...
	  if (user.data) {
	    OfflineSave.sync(user.data, endpoint).then(function (userData) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _snaplist = __webpack_require__(19);
	...
	var SnapList = _react2.default.createClass({
	  ...
	  renderSnapList: function renderSnapList(snaps) {
	    ...
	    return snaps.map(function (snap, i) {
	      return _react2.default.createElement(
	        'li',
	        { key: Date.now() + i, className: 'col-sm-4', tabIndex: i + 4 },
	        _react2.default.createElement(
	          'a',
	          { href: '#', onClick: _this2.openModal(i) },
	          _react2.default.createElement('img', { src: '/images/upload/' + snap.filename, className: 'img-responsive', alt: 'Snap image:' + i })
	        )
	      );
	    });
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _webcamcanvas = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _geolocate = __webpack_require__(23);
	...
	var WebCamCanvas = _react2.default.createClass({
	  ...
	  handleChange: _handleChange2.default,
	  getCurrentPosition: function getCurrentPosition(isOnline) {
	    var _this = this;
	  ...
	  getGeoCoordinates: function getGeoCoordinates() {
	  ...
	  renderVideo: function renderVideo() {
	    var self = this;
	    self.getUserMedia({ video: true }, self.handleVideo, function (e) {
	      console.log('video error', e);
	    });
	  },
	  debounceSubmit: function debounceSubmit() {
	    var _this2 = this;
	  ...
	  handleSubmit: function handleSubmit(e) {
	    ...
	    if (!navigator.onLine) {
	      ...
	      return _offlinesave2.default.save(postRequest);
	    } else {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'form-group', hidden: !this.state.showSave },
	        _react2.default.createElement('input', { type: 'submit', className: 'btn btn-primary btn-block', value: 'Save' })
	      ),
	      _react2.default.createElement(
	        'div',
	        { hidden: this.state.message.value === false, className: 'padding text-center ' + this.state.message.className },
	        _react2.default.createElement(
	          'p',
	          null,

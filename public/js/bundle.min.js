	...
	var Wrapper = _react2.default.createClass({
	  ...
	  pollOfflineData: function pollOfflineData() {
	    this.timer = setInterval(function () {
	      _offlinesave2.default.checkForOfflineData(_auth2.default.getCurrentUser(), '/snap/', navigator.isOnline);
	    }, 5000);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	OfflineSave.save = function (data) {
	  ...
	  var user = _auth2.default.getUserById(base);
	  base = 'geosnap_' + base;
	...
	OfflineSave.sync = function (userData, endpoint) {
	  ...
	  userData.forEach(function (data, i) {
	    ...
	    (0, _makerequest2.default)(endpoint, request).then(function (response) {
	      if (!response.success) {
